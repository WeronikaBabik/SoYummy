...
//         <Route index element={<Main />} /> //<Main /> is not a page but a part of home page which renders differently for logged users and displays 'welcome page' for not logged guests
